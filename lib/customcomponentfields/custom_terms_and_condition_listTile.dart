...
class _RenderListTile extends RenderBox {
  ...
  static const double _minVerticalPadding = 15;
  ...
  double get _defaultTileHeight {
    ...
    if (isOneLine) return isDense ? 40.0 : 56.0;
  ...
  void performLayout() {
    ...
    if (!hasSubtitle) {
      ...
      titleY = (lead == true)
          ? (tileHeight - titleSize.height) / 1.0
          : (tileHeight - titleSize.height) / 2.0;
    } else {
      ...
      if (titleY < _minVerticalPadding ||
          (subtitleY + subtitleSize.height + _minVerticalPadding) >
              tileHeight) {
        tileHeight =
            titleSize.height + subtitleSize.height + 1.0 * _minVerticalPadding;
