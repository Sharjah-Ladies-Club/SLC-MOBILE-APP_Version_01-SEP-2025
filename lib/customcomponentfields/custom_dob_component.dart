...
class CustomDOBComponent extends StatefulWidget {
  ...
  _CustomDOBComponentState createState() => _CustomDOBComponentState();
}

class _CustomDOBComponentState extends State<CustomDOBComponent> {
...
//                    widget.dobController.text, DateTimeUtils.YYYY_MM_DD_Format);
  ...
  void showDatePicker() {
    DatePicker.showDatePicker(
      ...
      minDateTime: widget.isFutureDate != null && widget.isFutureDate
          ? DateTime.parse(Constants.CURRENT_DATETIME)
          : DateTime.parse(Constants.MIN_DATETIME),
      maxDateTime: DateTime.parse(widget.isAddPeople
          ? Constants.EVENTMAX_DATETIME
          : widget.isFutureDate != null && widget.isFutureDate
              ? Constants.FUTURE_DATETIME
              : Constants.MAX_DATETIME),
