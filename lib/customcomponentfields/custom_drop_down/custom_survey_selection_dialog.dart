...
class SelectionDialog extends StatefulWidget {
  final List<FacilityResponse> elements;
  ...
  final List<FacilityResponse> favoriteElements;
...
class _SelectionDialogState extends State<SelectionDialog> {
  ...
  List<FacilityResponse> filteredElements;
  ...
  Widget _buildOption(FacilityResponse e) {
    return Container(
      width: 400,
      child: Flex(
  ...
  Widget _buildEmptySearchWidget(BuildContext context) {
    ...
    // Text(tr("No Facility Items Found!")));
  }
  ...
  void _filterElements(String s) {
    ...
    setState(() {
      filteredElements = widget.elements
          .where((e) =>
              e.facilityName.contains(s) ||
              e.facilityName.toUpperCase().contains(s) ||
              e.facilityName.toLowerCase().contains(s))
          .toList();
    });
  }

  void _selectItem(FacilityResponse e) {
