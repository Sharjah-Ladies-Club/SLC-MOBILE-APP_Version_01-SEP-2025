...
/// selection dialog used for selection of the food code
class FoodSelectionDialog extends StatefulWidget {
  final List<FoodCode> elements;
  ...
  final List<FoodCode> favoriteElements;

  FoodSelectionDialog(this.elements, this.favoriteElements,
      {Key key,
      this.showFoodOnly,
  ...
  @override
  State<StatefulWidget> createState() => _FoodSelectionDialogState();
}

class _FoodSelectionDialogState extends State<FoodSelectionDialog> {
  /// this is useful for filtering purpose
  List<FoodCode> filteredElements;
  ...
  Widget _buildOption(FoodCode e) {
    return Container(
      width: 400,
      child: Flex(
...
//              e.foodId.toString().contains(s) ||
          e.mealName.toUpperCase().contains(s)).toList();
    });
  }

  void _selectItem(FoodCode e) {
