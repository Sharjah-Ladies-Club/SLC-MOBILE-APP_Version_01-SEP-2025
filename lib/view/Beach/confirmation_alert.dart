...
class ConfirmationAlert extends StatelessWidget {
  ...
  ConfirmationAlert({this.merchantReferenceNo});
  @override
...
class _ConfirmationAlert extends StatefulWidget {
  String merchantReferenceNo = "";
  OrderStatus orderStatus = new OrderStatus();
  _ConfirmationAlert({this.merchantReferenceNo});
  @override
  _ConfirmationAlertState createState() =>
      _ConfirmationAlertState(merchantReferenceNo: merchantReferenceNo);
}

class _ConfirmationAlertState extends State<_ConfirmationAlert> {
  String merchantReferenceNo = "";
  OrderStatus orderStatus = new OrderStatus();
  _ConfirmationAlertState({this.merchantReferenceNo});
  @override
  void initState() {
