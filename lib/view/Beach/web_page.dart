...
class BeachWebviewPage extends StatefulWidget {
  BeachWebviewPage(
  ...
  @override
  _BeachWebviewPageState createState() => _BeachWebviewPageState();
}

class _BeachWebviewPageState extends State<BeachWebviewPage> {
