...
class RetailCartPaymentPage extends StatefulWidget {
  int facilityId = 0;
  ...
  _RetailCartPayment createState() => _RetailCartPayment(
...
class _RetailCartPayment extends State<RetailCartPaymentPage> {
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () async {
                              setState(() {
                                ...
                                selectedDeliveryCharges = new DeliveryCharges();
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              if (deliveryAddresses.length > 0) {
                                _onChangeOptionDropdown(deliveryAddresses[0]);
                              }
                            },
                            // textColor: Colors.white,
                            //color: Theme.of(context).primaryColor,
...
//                                color: Colors.black45,
                  ...
                  (valuefirst != false &&
                      ...
                      ? Container(
                          ...
                          child: Column(children: [
                                    ...
                                    onPressed: () async {
                                      ...
                                      Meta m = await FacilityDetailRepository()
                                          .getEnquiryPaymentOrderRequest(
                                              ...
                                              charges: selectedDeliveryCharges,
                                              ...
                                              deliveryAmount: widget
                                                          .deliveryTaxableAmt ==
                                                      null
                                                  ? 0
                                                  : widget.deliveryTaxableAmt,
                                              deliveryTaxAmount:
                            ...
                            //         children: <Widget>[
                            //           Container(
                            //             child: Text(tr('proceed_to_samsungpay'),
                            //                 style: EventPeopleListPageStyle
                            //                     .eventPeopleListPageBtnTextStyleWithAr(
                            //                         context)),
                            //           ),
                            ...
                            //                   new Map<String, dynamic>.from(
                            //                       val);
                            //               String samsungPayUrl =
                            //                   payment["samsungPayUrl"];
                            //               int orderId = payment["orderId"];
                            //               String merchantReferenceNo =
                            //                   payment['merchantReferenceNo'];
                            //               String merchantIdentifier = payment[
                            //                   'samsungMerchantIdentifier'];
                            //               String facilityName =
                            //                   payment['facilityName'];
                            //               // makeSamsungPayment(
                            //               //     widget.total,
  ...
  void getTotal() {
    double totalAmt = 0;
    // double totalAmtWithoutPromotion = 0.0;
    widget.taxAmt = 0;
    widget.taxableAmt = 0;
    ...
    if (widget.showGiftCardRedeem) {
      setState(() {
        ...
        if (widget.total >= voucher.balanceAmount) {
          _giftVoucherUsedAmount.text =
              voucher.balanceAmount.toStringAsFixed(2);
  ...
  bool checkGiftCardAmount(double enterAmt) {
    if (enterAmt < 100 && widget.selectedVoucher.balanceAmount > 100) {
      _vchErrorText = tr("amount_should_be_hundred_or_greater");
      return false;
    } else if (widget.selectedVoucher.balanceAmount < 100) {
      _giftVoucherUsedAmount.text =
          widget.selectedVoucher.balanceAmount.toStringAsFixed(2);
    }
    return true;
  }
  ...
  int validGiftCardAmount() {
    ...
    if (widget.selectedVoucher != null) {
      if (widget.selectedVoucher.giftVoucherId > 0) {
        if (_giftVoucherUsedAmount.text != "" &&
          ...
          if (widget.total >= widget.selectedVoucher.balanceAmount) {
            result = -1;
            return result;
          } else if (widget.total < widget.selectedVoucher.balanceAmount) {
            result = -1;
            return result;
          }
        }
