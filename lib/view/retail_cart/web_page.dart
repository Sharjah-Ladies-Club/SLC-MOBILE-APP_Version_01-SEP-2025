...
class RetailCartWebviewPage extends StatefulWidget {
  RetailCartWebviewPage(
  ...
  @override
  _RetailCartWebviewPageState createState() => _RetailCartWebviewPageState();
}

class _RetailCartWebviewPageState extends State<RetailCartWebviewPage> {
  ...
  void initState() {
    ...
    _onStateChanged = flutterWebViewPlugin.onStateChanged.listen((
      ...
      if (state.url.contains("http://192.210.7.15/slcapi/api/facilities/enquiry-payment-result") ||
          state.url.contains(
