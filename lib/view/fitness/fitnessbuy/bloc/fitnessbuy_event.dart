...
abstract class FitnessBuyEvent extends Equatable {
  const FitnessBuyEvent();
}

class GetItemDetailsEvent extends FitnessBuyEvent {
...
class GetDiscountEvent extends FitnessBuyEvent {
  final int facilityId;
...
class GetOrderStatusEvent extends FitnessBuyEvent {
...
class GetPaymentTerms extends FitnessBuyEvent {
  final int facilityId;
...
class FitnessBuyEnquirySaveEvent extends FitnessBuyEvent {
