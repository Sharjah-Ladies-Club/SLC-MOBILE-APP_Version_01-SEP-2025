...
import 'package:slc/view/fitness/fitnessbuy/fitnessbuy_confirmation_alert.dart';
import 'package:slc/view/fitness/fitnessbuy/web_page.dart';
import 'package:slc/view/fitness/gymentry.dart';
import 'package:slc/view/fitness/personaltraining.dart';

class FitnessBuyPaymentPage extends StatefulWidget {
  int facilityId = 0;
  ...
  @override
  _FitnessBuyPayment createState() => _FitnessBuyPayment(
...
class _FitnessBuyPayment extends State<FitnessBuyPaymentPage> {
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            if (widget.screenCode == 1) {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) =>
                          GymEntryPage(screenType: 1, colorCode: "A81B8D")));
            } else if (widget.screenCode == 2) {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) =>
                          GymEntryPage(screenType: 2, colorCode: "A81B8D")));
            } else if (widget.screenCode == 4) {
              Navigator.push(
                  context,
                  MaterialPageRoute(
...
//                                color: Colors.black45,
    ...
    for (int i = 0; i < widget.facilityItems.length; i++) {
      ...
      print(
          "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD" +
              widget.facilityItems[i].isDiscountable.toString());

      if (widget.facilityItems[i].isDiscountable) {
        totalAmtWithoutPromotion = (widget.facilityItems[i].price * itemCount);
  ...
  void openWebView(String url) {
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => FitnessBuyWebviewPage(
                  title: tr("payment"),
                  url: val,
