...
class FacilityBuyWebviewPage extends StatefulWidget {
  FacilityBuyWebviewPage(
  ...
  final String title;
  int facilityId;
  KunoozBookingDto facilityItems;

  @override
  _FacilityBuyWebviewPageState createState() => _FacilityBuyWebviewPageState();
}

class _FacilityBuyWebviewPageState extends State<FacilityBuyWebviewPage> {
  ...
  void initState() {
    ...
    _onStateChanged = flutterWebViewPlugin.onStateChanged.listen((
      ...
      if (state.url.contains("http://192.168.1.5/slcapi/api/facilities/enquiry-payment-result") ||
          state.url.contains(
