...
//  Container(margin:EdgeInsets.only(bottom: 15.0, left: 10.0, right: 10.0),child:
          ...
          Container(
              ...
              child: PackageListHead.textFieldIsBlue(context, 'password',
...
// ),
          PackageListHead.customTextView(
              context, 0.4, tr('otpSendToTxt'), false, FontWeight.w500),
          // Text(
          //   ,
          ...
          PackageListHead.customTextView(
              context, 1.0, widget.mobileNumber, false, FontWeight.bold)
        ],
      ),
    );
  }
...
//   }
  ...
  void _onTextChanged(text) {
    ...
    setState(() {
      this.text = text;
      if (strList.length < text.length && text.length < currentIndex) {
  ...
  Widget _buildPinCode(int i, BuildContext context) {
    ...
    return Container(
        // height: 60.0,
        // width: 50.0,
        margin: EdgeInsets.only(left: 6.0, right: 6.0, top: 5.0),
        child: Padding(
          padding: insets,
          child: Card(
