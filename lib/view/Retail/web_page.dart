...
class RetailWebviewPage extends StatefulWidget {
  RetailWebviewPage(
  ...
  @override
  _RetailWebviewPageState createState() => _RetailWebviewPageState();
}

class _RetailWebviewPageState extends State<RetailWebviewPage> {
