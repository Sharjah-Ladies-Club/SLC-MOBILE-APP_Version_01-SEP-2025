...
import 'package:slc/view/Retail/bloc/retail_bloc.dart';
import 'package:slc/view/Retail/bloc/retail_event.dart';
import 'package:slc/view/Retail/bloc/retail_state.dart';

class RetailConfirmationAlert extends StatelessWidget {
  String merchantReferenceNo = "";
  RetailConfirmationAlert({this.merchantReferenceNo});
  @override
...
class _RetailConfirmationAlert extends StatefulWidget {
  String merchantReferenceNo = "";
  OrderStatus orderStatus = new OrderStatus();
  _RetailConfirmationAlert({this.merchantReferenceNo});
  @override
  _RetailConfirmationAlertState createState() =>
      _RetailConfirmationAlertState(merchantReferenceNo: merchantReferenceNo);
}

class _RetailConfirmationAlertState extends State<_RetailConfirmationAlert> {
  String merchantReferenceNo = "";
  OrderStatus orderStatus = new OrderStatus();
  _RetailConfirmationAlertState({this.merchantReferenceNo});
  @override
  void initState() {
